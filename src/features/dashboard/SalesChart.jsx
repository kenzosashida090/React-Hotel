    ...
    <StyledSalesChart>
      ...
      <ResponsiveContainer height={300} width="100%">
        <AreaChart data={data } >
          ...
          <Area strokeWidth={2} name="Total sales" unit="$" dataKey="totalSales" type="monotone" stroke={colors.totalSales.stroke} fill={colors.totalSales.fill} />
          <Area strokeWidth={2} name="Extras sales" unit="$" dataKey="extrasSales" type="monotone" stroke={colors.extrasSales.stroke} fill={colors.extrasSales.fill} />
        </AreaChart>
      </ResponsiveContainer>
    </StyledSalesChart>
  )
